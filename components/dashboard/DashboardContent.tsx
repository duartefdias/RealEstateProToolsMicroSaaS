      ...
      <div className="space-y-8">
        ...
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground">
            ...
            {isProUser && (
              <span className="text-purple-600 font-medium"> (Pro Plan Active)</span>
            )}
          </p>
        </div>
        ...
        {isProUser ? (
          /* Pro User - Show Pro Features Overview */
          <Card className="border-green-200 bg-green-50">
            ...
            <CardContent className="space-y-4">
              <div className="grid gap-2 text-sm">
                ...
                <div className="flex items-center gap-2">
                  <Icons.tasks className="h-4 w-4 text-green-600" />
                  <span>Task and follow-up tracking</span>
                </div>
                <div className="flex items-center gap-2">
                  <Icons.chart className="h-4 w-4 text-green-600" />
